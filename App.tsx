        ...
        {renderContent()}
         <footer className="mt-8 pt-6 border-t border-gray-700 text-center">
          <p className="text-sm text-gray-500">
            Disclaimer: This application is designed to build intuition for statistical concepts. While efforts have been made for accuracy, it is intended as an educational tool and not a professional statistical software. All calculations and explanations should be verified with authoritative sources. Please send corrections to geokshitij@gmail.com. Thank you.
          </p>
        </footer>
      </main>
    </div>
